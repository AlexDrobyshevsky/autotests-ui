...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_title_input = page.get_by_test_id(
            'create-course-form-title-input').locator('input')
        self.create_course_estimated_input = page.get_by_test_id(
            'create-course-form-estimated-time-input').locator('input')
        self.create_course_description_textarea = page.get_by_test_id(
        ...
        self.create_course_min_score_input = page.get_by_test_id(
            'create-course-form-min-score-input').locator('input')
    ...
    def check_visible_create_course_form(
        ...
        expect(self.create_course_estimated_input).to_be_visible()
        expect(self.create_course_estimated_input).to_have_value(estimated_time)
    ...
    def fill_create_course_form(
        ...
        self.create_course_estimated_input.fill(estimated_time)
        expect(self.create_course_estimated_input).to_have_value(estimated_time)
