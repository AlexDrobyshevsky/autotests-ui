...
def test_create_course(courses_list_page: CoursesListPage, create_course_page: CreateCoursePage):
    ...
    create_course_page.create_toolbar_view.check_visible(is_create_course_disabled=True)
    ...
    create_course_page.exercises_toolbar_view.check_visible_button()
    ...
    create_course_page.create_toolbar_view.check_visible(is_create_course_disabled=False)
